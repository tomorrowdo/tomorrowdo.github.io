...
用户为自己的二级域名创建主页很容易，只要在托管空间下创建
一个名为<user-id>.github.io的版本库，向其master分支提交
网站静态页面即可，其中网站首页为index.html。利用这一点我们
可以搭建一个免费的300兆的托管的博客主页！！


![github logo](/photo/readme.jpg)
